...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_description_SOURCE_PREFIX /home/akarshb2/3D-LiDAR-SLAM/src/velodyne/velodyne_description)
  set(velodyne_description_DEVEL_PREFIX /home/akarshb2/3D-LiDAR-SLAM/devel)
  ...
  set(velodyne_description_INSTALL_PREFIX /home/akarshb2/3D-LiDAR-SLAM/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/akarshb2/3D-LiDAR-SLAM/src/velodyne/velodyne_description/${idir}'.  ${_report}")
    endif()
